...
#define AINCOOF3  ( ( RA1 + RA4 ) /RA4) * K

#define INDIOD  0.45


#define MAX_CAL_POINT  20
#define MAX_TOTAL_CAL_POINT  ( ADC_CHANNEL * MAX_CAL_POINT  ) //Суммароне количество калибровочных точек
#define MAX_DAC_TOTAL_CAL_POINT  ( DAC_NUMBER * MAX_CAL_POINT  ) //Суммароне количество калибровочных точек
#define MAX_COOF_COUNT       ( ADC_CHANNEL * ( MAX_CAL_POINT -1 ) )
#define MAX_DAC_COOF_COUNT       ( DAC_NUMBER * ( MAX_CAL_POINT -1 ) )
