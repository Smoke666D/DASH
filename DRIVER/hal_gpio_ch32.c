 ...
 */
INIT_FUNC_LOC void HAL_InitGpioOut( PortName_t PORT, uint16_t Pin  )
{
 ...
 */
INIT_FUNC_LOC void HAL_InitGpioInPUP(PortName_t PORT, uint16_t Pin)
{
 ...
 */
INIT_FUNC_LOC void HAL_InitGpioIn(PortName_t PORT, uint16_t Pin)
{
 ...
 */
INIT_FUNC_LOC void HAL_InitGpioAF(PortName_t PORT, uint16_t Pin, uint32_t AF ,  GPIO_MODE_t mode )
{
    if (AF != 0 )
    {
...
INIT_FUNC_LOC static const uint32_t PERIPH_MASK[GPIO_PORT_COUNT] = { RCC_APB2Periph_GPIOA,RCC_APB2Periph_GPIOB,RCC_APB2Periph_GPIOC};
#endif

INIT_FUNC_LOC  void HAL_InitGPO()
 {
